...
export default function Sidebar() {
  ...
  return (
    <aside
      ...
      className={`fixed left-0 top-0 h-full bg-white text-slate-900 shadow-lg transition-all duration-300 ease-in-out z-40 ${
    ...
    >
      <div className="flex flex-col gap-6 px-4 py-8 h-full">
        ...
        <div className="flex items-center gap-3 justify-start">
          <div className="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-2xl bg-cyan-500 text-xl font-semibold text-white">
            📊
          </div>
          {isExpanded && (
            <div className="overflow-hidden">
              <p className="text-xs uppercase tracking-[0.24em] text-slate-500 whitespace-nowrap">EMS</p>
